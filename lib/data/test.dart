...
Map<String, List<User>> users = {
  'users': [
    User.fromJson({
      ...
      'posts': posts['Tech']!
      .where((element) => element.author == 'Ahmed')
    ...
    User.fromJson({
     ...
     'posts': posts['Tech']!
      .where((element) => element.author == 'Fahad')
      .map((post) => post.toJson()) 
      .toList(),
      'saved': []
    }),
    User.fromJson({
      ...
      'posts': posts['Tech']!
      .where((element) => element.author == 'Abdulaziz')
      .map((post) => post.toJson()) 
      .toList(),
      'saved': []
    }),
    User.fromJson({
      ...
      'posts': posts['Tech']!
      .where((element) => element.author == 'Laura')
      .map((post) => post.toJson()) 
      .toList(),
      'saved': []
    }),
    User.fromJson({
      ...
      'posts': posts['Tech']!
      .where((element) => element.author == 'Ethan')
      .map((post) => post.toJson()) 
      .toList(),
      'saved': []
    }),
    User.fromJson({
      ...
      'posts': posts['Tech']!
      .where((element) => element.author == 'Olivia')
      .map((post) => post.toJson()) 
      .toList(),
      'saved': []
    }),
    User.fromJson({
      ...
      'posts': posts['Tech']!
      .where((element) => element.author == 'Sophia')
      .map((post) => post.toJson()) 
      .toList(),
      'saved': []
    }),
