        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
                    ...
                    Center(
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            const Text("You are not logged in yet",style: TextStyle(fontSize: 12,fontWeight: FontWeight.w700,color: Colors.white),),
                            ...
                            SizedBox(
                              ...
                              child: ElevatedButton(
                                ...
                                child: const Text("Login",style: TextStyle(fontSize: 24,fontWeight: FontWeight.w800,color: Color(0xffbda6f5)),)
                              ),
                            )
                          ],
                        ),
              ...
              const Text("My Blogs", style: TextStyle(fontSize: 18, fontWeight: FontWeight.w700, color: Colors.white),),
              ...
              Center(
                child: SizedBox(
                  ...
                  }, child: const Text("Logout", style: TextStyle(fontSize: 24, fontWeight: FontWeight.w800, color: Color(0xffDD403C)),)),
                ),
              )
            ],
          ),
