                        ...
                        Row(
                          children: [
                            ...
                            Padding(
                              ...
                              child: CustomText(text: e.title, color: Colors.white, size: 11),
                            ),
                            Row(
                              children: [
                                    Padding(
                                      padding: const EdgeInsets.only(left: 135, top: 25),
                                      child: IconButton(onPressed: (){}, icon: const Icon(Icons.edit_outlined, color: Colors.white,)),
                                    ),
                                                         Padding(
                                                           padding: const EdgeInsets.only(top: 25),
                                                           child: IconButton(onPressed: (){
                                                             GetIt.I.get<BlogData>().removeBlog(id: e.id);
